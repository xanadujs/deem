...
stocks.forEach(function(stockId) {
    ...
    // console.log("ttmObj", stockId, ttmObj[stockId])
    if (duration>40
        && (support0>5|| support1>5)
        && ttmObj[stockId] < 20 && ttmObj[stockId] >0
        && klj.netsummax_r0+klj.netsummax_r0_netsum_r0x>0.01*marketCap
        && (klj.netsum_r0_20 > 0 || klj.netsum_r0_40 > 0)
        // && klj.netsum_r0_above > 0
        ...
        counter++;
        console.log(stockId, ttmObj[stockId])
        ...
        //     "resistance:",resistanceArr[0]+"/"+priceMap[resistanceArr[0]], resistanceArr[1]+"/"+priceMap[resistanceArr[1]])
           ...
           emailbody += "<a href='http://finance.sina.com.cn/realstock/company/"+stockId.toLowerCase()+"/nc.shtml'>"
                        +stockId+"</a> "
                        + "<b>"+klineJson[maxr0netsumidx].date+"-"+targetDateStr+"</b> <br>"
...
//console.log(emailbody);
        mailutil.sendEmail("PE", "Total:"+counter+"<br>"+emailbody, "yang_dx@126.com,coolinker@gmail.com,lllxly@qq.com");
}
console.timeEnd("run");
