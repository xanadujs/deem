...
public class GbkName {  
    ...
    public static void main(String[] args) throws Exception {  
        ...
        for (int i=0; i<stocks.length; i++) {
            ...
            stockstr += stocks[i].substring(0,8).toLowerCase()+",";
            if (i>0 && i%500==0 || i==stocks.length-1) {
                String gbk = HttpRequest("http://hq.sinajs.cn/list="+stockstr);
                gbkcotent +=gbk; 
                stockstr = "";
            }
        }

        writeToFile("deem/datasource/stockNames.txt", gbkcotent); 
    ...
    public static String[] getStockArr(){
        String path = "deem\\datasource\\klines_base";  
